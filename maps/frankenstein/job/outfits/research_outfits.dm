/decl/hierarchy/outfit/job/argos/crew/research
	name = OUTFIT_JOB_NAME("Research Assistant - Argos")
	uniform = /obj/item/clothing/under/rank/scientist_new
	shoes = /obj/item/clothing/shoes/dutyboots
	id_type = /obj/item/weapon/card/id/argos/crew/research
	pda_type = /obj/item/modular_computer/pda/science
	l_ear = /obj/item/device/radio/headset/argossci

/decl/hierarchy/outfit/job/argos/crew/research/scientist
	name = OUTFIT_JOB_NAME("Scientist - Argos")
	uniform = /obj/item/clothing/under/rank/scientist_new
...
/decl/hierarchy/outfit/job/argos/crew/research/janitor
	name = OUTFIT_JOB_NAME("Custodian - Argos")
...
/decl/hierarchy/outfit/job/argos/crew/research/roboticist
	name = OUTFIT_JOB_NAME("Roboticist - Argos")
	uniform = /obj/item/clothing/under/rank/roboticist
	shoes = /obj/item/clothing/shoes/black
	id_type = /obj/item/weapon/card/id/argos/crew/research/roboticist
