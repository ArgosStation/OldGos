...
/obj/structure/closet/secure_closet/cargotech_argos
...
/obj/structure/closet/secure_closet/quartermaster_argos
	name = "quartermaster's locker"
	req_access = list(access_qm)
	closet_appearance = /decl/closet_appearance/secure_closet/argos/cargo/deck_officer
