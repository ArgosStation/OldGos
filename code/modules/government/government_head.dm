...
/obj/item/clothing/head/soft/solgov
	...
	desc = "It's a ballcap in Axis colors."
	icon_state = "solsoft"
	icon = 'maps/torch/icons/obj/obj_head_solgov.dmi'
	item_icons = list(slot_head_str = 'maps/torch/icons/mob/onmob_head_solgov.dmi')
...
/obj/item/clothing/head/soft/solgov/fleet
	name = "fleet cap"
	desc = "It's a navy blue field cap with the Axis Fleet crest in a silver colour."
...
/obj/item/clothing/head/solgov/utility/fleet
	...
	desc = "A navy blue utility cover bearing the crest of the Sol-Ceti Axis Fleet."
	icon_state = "navyutility"

/obj/item/clothing/head/solgov/utility/army
	name = "army utility cover"
	desc = "A green utility cover bearing the crest of the Sol-Ceti Axis Army."
	icon_state = "greenutility"

/obj/item/clothing/head/solgov/utility/army/tan
	name = "tan utility cover"
	desc = "A tan utility cover bearing the crest of the Sol-Ceti Axis Army."
	icon_state = "tanutility"

/obj/item/clothing/head/solgov/utility/army/urban
	name = "urban utility cover"
	desc = "A grey utility cover bearing the crest of the Sol-Ceti Axis Army."
	icon_state = "greyutility"
...
/obj/item/clothing/head/solgov/service/expedition
	...
	desc = "A peaked black uniform cap belonging to the Sol-Ceti Axis Expeditionary Corps."
...
/obj/item/clothing/head/solgov/service/expedition/command
	...
	desc = "A peaked black uniform cap belonging to the Sol-Ceti Axis Expeditionary Corps. This one is trimmed in gold."
...
/obj/item/clothing/head/solgov/service/expedition/captain
	...
	desc = "A gold-trimmed peaked black uniform cap belonging to a Captain of the Sol-Ceti Axis Expeditionary Corps."
...
/obj/item/clothing/head/solgov/service/expedition/senior_command
	...
	desc = "A peaked grey uniform cap belonging to the Sol-Ceti Axis Expeditionary Corps. This one is trimmed in gold and blue."
	icon_state = "greydresscap_senior"

/obj/item/clothing/head/solgov/service/army
	name = "army wheel cover"
	desc = "A green service uniform cover with an Sol-Ceti Axis Army crest."
	icon_state = "greenwheelcap"

/obj/item/clothing/head/solgov/service/army/command
	name = "army officer's wheel cover"
	desc = "A green service uniform cover with an Sol-Ceti Axis Army crest and gold stripe."
	icon_state = "greenwheelcap_com"

/obj/item/clothing/head/solgov/service/army/garrison
	name = "army garrison cap"
	desc = "A green garrison cap belonging to the Sol-Ceti Axis Army."
	icon_state = "greengarrisoncap"

/obj/item/clothing/head/solgov/service/army/garrison/command
	name = "army officer's garrison cap"
	desc = "A green garrison cap belonging to the Sol-Ceti Axis Army. This one has a gold pin."
	icon_state = "greengarrisoncap_com"

/obj/item/clothing/head/solgov/service/army/campaign
	name = "campaign cover"
	desc = "A green campaign cover with an Sol-Ceti Axis Army crest. Only found on the heads of Drill Sergeants."
...
/obj/item/clothing/head/beret/solgov/marcom
	...
	desc = "A red beret with a gold insignia, denoting service in the Sol-Ceti AxisDF Mars Central Command. For brass who are more inclined towards style than safety."
	icon_state = "beret_redgold"

/obj/item/clothing/head/beret/solgov/stratcom
	name = "\improper STRATCOM beret"
	desc = "A grey beret with a silver insignia, denoting service in the Sol-Ceti AxisDF Strategic Command. For intelligence personnel who are more inclined towards style than safety."
	icon_state = "beret_graysilver"

/obj/item/clothing/head/beret/solgov/diplomatic
	name = "diplomatic security beret"
	desc = "A tan beret denoting service in the Sol-Ceti Axis Army Diplomatic Security Group. For security personnel who are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition
	...
	desc = "A black beret belonging to the Sol-Ceti Axis Expeditionary Corps. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/security
	...
	desc = "An Sol-Ceti Axis Expeditionary Corps beret with a security crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_security"

/obj/item/clothing/head/beret/solgov/expedition/medical
	name = "expeditionary medical beret"
	desc = "An Sol-Ceti Axis Expeditionary Corps beret with a medical crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/engineering
	...
	desc = "An Sol-Ceti Axis Expeditionary Corps beret with an engineering crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_engineering"

/obj/item/clothing/head/beret/solgov/expedition/supply
	name = "expeditionary supply beret"
	desc = "An Sol-Ceti Axis Expeditionary Corps beret with a supply crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_supply"

/obj/item/clothing/head/beret/solgov/expedition/service
	name = "expeditionary service beret"
	desc = "An Sol-Ceti Axis Expeditionary Corps beret with a service crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/exploration
	...
	desc = "An Sol-Ceti Axis Expeditionary Corps beret with an exploration crest. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/command
	...
	desc = "An Sol-Ceti Axis Expeditionary Corps beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_command"

/obj/item/clothing/head/beret/solgov/expedition/branch
	name = "\improper Field Operations beret"
	desc = "An Sol-Ceti Axis Fleet beret carrying insignia of the Field Operations section of the Expeditionary Corps. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/beret/solgov/expedition/branch/observatory
	...
	desc = "An Sol-Ceti Axis Fleet beret carrying insignia of the Observatory section of the Expeditionary Corps. For personnel that are more inclined towards style than safety."
	icon_state = "beret_black_observatory"

/obj/item/clothing/head/beret/solgov/fleet
	name = "fleet beret"
	desc = "A navy blue beret belonging to the Sol-Ceti Axis Fleet. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy"

/obj/item/clothing/head/beret/solgov/fleet/security
	name = "fleet security beret"
	desc = "An Sol-Ceti Axis Fleet beret with a security crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_security"

/obj/item/clothing/head/beret/solgov/fleet/medical
	name = "fleet medical beret"
	desc = "An Sol-Ceti Axis Fleet beret with a medical crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_medical"

/obj/item/clothing/head/beret/solgov/fleet/engineering
	name = "fleet engineering beret"
	desc = "An Sol-Ceti Axis Fleet with an engineering crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_engineering"

/obj/item/clothing/head/beret/solgov/fleet/supply
	name = "fleet supply beret"
	desc = "An Sol-Ceti Axis Fleet beret with a supply crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_supply"

/obj/item/clothing/head/beret/solgov/fleet/service
	name = "fleet service beret"
	desc = "An Sol-Ceti Axis Fleet beret with a service crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_service"

/obj/item/clothing/head/beret/solgov/fleet/exploration
	name = "fleet exploration beret"
	desc = "An Sol-Ceti Axis Fleet beret with an exploration crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_exploration"

/obj/item/clothing/head/beret/solgov/fleet/command
	name = "fleet officer's beret"
	desc = "An Sol-Ceti Axis Fleet beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_command"

/obj/item/clothing/head/beret/solgov/fleet/dress
	name = "fleet dress beret"
	desc = "A white Sol-Ceti Axis Fleet beret. For personnel that are more inclined towards style than safety."
	icon_state = "beret_whiterim"

/obj/item/clothing/head/beret/solgov/fleet/dress/command
	name = "fleet officer's dress beret"
	desc = "A white Sol-Ceti Axis Fleet beret with a golden crest. For personnel that are more inclined towards style than safety."
	icon_state = "beret_whiterim_com"

/obj/item/clothing/head/beret/solgov/fleet/branch
	name = "first fleet beret"
	desc = "An Sol-Ceti Axis Fleet beret carrying insignia of First Fleet, the Sol Guard, stationed in Sol. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_first"

/obj/item/clothing/head/beret/solgov/fleet/branch/second
	name = "second fleet beret"
	desc = "An Sol-Ceti Axis Fleet beret carrying insignia of Second Fleet, the Home Guard, tasked with defense of Sol territories. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_second"

/obj/item/clothing/head/beret/solgov/fleet/branch/third
	name = "third fleet beret"
	desc = "An Sol-Ceti Axis Fleet beret carrying insignia of Third Fleet, the Border Guard, guarding borders of Sol territory against Vox and pirates. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_third"

/obj/item/clothing/head/beret/solgov/fleet/branch/fourth
	name = "fourth fleet beret"
	desc = "An Sol-Ceti Axis Fleet beret carrying insignia of Fourth Fleet, stationed on Skrell border. For personnel that are more inclined towards style than safety."
	icon_state = "beret_navy_fourth"

/obj/item/clothing/head/beret/solgov/fleet/branch/fifth
	name = "fifth fleet beret"
	desc = "An Sol-Ceti Axis Fleet beret carrying insignia of Fifth Fleet, the Quick Reaction Force, recently formed and outfited with last tech. For personnel that are more inclined towards style than safety."
...
/obj/item/clothing/head/ushanka/solgov
	...
	desc = "An Sol-Ceti Axis Expeditionary Corps synthfur-lined hat for operating in cold environments."
	icon = 'maps/torch/icons/obj/obj_head_solgov.dmi'
	item_icons = list(slot_head_str = 'maps/torch/icons/mob/onmob_head_solgov.dmi')
...
/obj/item/clothing/head/ushanka/solgov/fleet
	name = "fleet fur hat"
	desc = "An Sol-Ceti Axis Fleet synthfur-lined hat for operating in cold environments."
	icon_state = "flushankadown"
	icon_state_up = "flushankaup"

/obj/item/clothing/head/ushanka/solgov/army
	name = "army fur hat"
	desc = "An Sol-Ceti Axis Army synthfur-lined hat for operating in cold environments."
...
/obj/item/clothing/head/helmet/solgov/pilot/fleet
	...
	desc = "A pilot's helmet for operating the cockpit in style. This one is worn by members of the Sol-Ceti Axis Fleet."
