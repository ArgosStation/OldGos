...
/obj/item/clothing/suit/storage/solgov/service/expeditionary
	...
	desc = "A uniform service jacket belonging to the Sol-Ceti Axis Expeditionary Corps."
...
/obj/item/clothing/suit/storage/solgov/service/fleet
	...
	desc = "A navy blue Sol-Ceti Axis Fleet service jacket."
	icon_state = "blueservice"

/obj/item/clothing/suit/storage/solgov/service/fleet/snco
	name = "fleet SNCO service jacket"
	desc = "A navy blue Sol-Ceti Axis Fleet service jacket with silver cuffs."
...
/obj/item/clothing/suit/storage/solgov/service/fleet/officer
	...
	desc = "A navy blue Sol-Ceti Axis Fleet dress jacket with silver accents."
...
/obj/item/clothing/suit/storage/solgov/service/fleet/command
	...
	desc = "A navy blue Sol-Ceti Axis Fleet dress jacket with gold accents."
...
/obj/item/clothing/suit/storage/solgov/service/fleet/flag
	...
	desc = "A navy blue Sol-Ceti Axis Fleet dress jacket with red accents."
	icon_state = "blueservice_flag"

/obj/item/clothing/suit/storage/solgov/service/army
	name = "army coat"
	desc = "An Sol-Ceti Axis Army service coat. Green and undecorated."
	item_state = "greenservice"

/obj/item/clothing/suit/storage/solgov/service/army/medical
	name = "army medical jacket"
	desc = "An Sol-Ceti Axis Army service coat. This one has blue markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/medical/command
	...
	desc = "An Sol-Ceti Axis Army service coat. This one has blue and gold markings."
	icon_state = "greenservice_medcom"

/obj/item/clothing/suit/storage/solgov/service/army/engineering
	name = "army engineering jacket"
	desc = "An Sol-Ceti Axis Army service coat. This one has orange markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/security/command
	...
	desc = "An Sol-Ceti Axis Army service coat. This one has red and gold markings."
	icon_state = "greenservice_seccom"

/obj/item/clothing/suit/storage/solgov/service/army/service
	name = "army service jacket"
	desc = "An Sol-Ceti Axis Army service coat. This one has green markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/service/command
	...
	desc = "An Sol-Ceti Axis Army service coat. This one has green and gold markings."
	icon_state = "greenservice_srvcom"

/obj/item/clothing/suit/storage/solgov/service/army/exploration
	name = "army exploration jacket"
	desc = "An Sol-Ceti Axis Army service coat. This one has purple markings."
...
/obj/item/clothing/suit/storage/solgov/service/army/exploration/command
	...
	desc = "An Sol-Ceti Axis Army service coat. This one has purple and gold markings."
	icon_state = "greenservice_expcom"

/obj/item/clothing/suit/storage/solgov/service/army/command
	name = "army command jacket"
	desc = "An Sol-Ceti Axis Marine Corps service coat. This one has gold markings."
...
/obj/item/clothing/suit/storage/solgov/dress/expedition
	...
	desc = "A silver and black dress peacoat belonging to the Sol-Ceti Axis Expeditionary Corps. Fashionable, for the 25th century at least."
	icon_state = "ecdress_xpl"
	sprite_sheets = list(
		SPECIES_UNATHI = 'icons/mob/species/unathi/onmob_suit_unathi.dmi'
		)
...
/obj/item/clothing/suit/storage/solgov/dress/expedition/command
	...
	desc = "A gold and black dress peacoat belonging to the Sol-Ceti Axis Expeditionary Corps. The height of fashion."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet
	...
	desc = "A navy blue Sol-Ceti Axis Fleet dress jacket. Don't get near pasta sauce or vox."
	icon_state = "whitedress"
	item_state = "whitedress"

/obj/item/clothing/suit/storage/solgov/dress/fleet/snco
	name = "fleet dress SNCO jacket"
	desc = "A navy blue Sol-Ceti Axis Fleet dress jacket with silver cuffs. Don't get near pasta sauce or vox."
	icon_state = "whitedress_snco"

/obj/item/clothing/suit/storage/solgov/dress/fleet/officer
	name = "fleet officer's dress jacket"
	desc = "A navy blue Sol-Ceti Axis Fleet dress jacket with silver accents. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/storage/solgov/dress/fleet/command
	...
	desc = "A navy blue Sol-Ceti Axis Fleet dress jacket with gold accents. Don't get near pasta sauce or vox."
	icon_state = "whitedress_comm"

/obj/item/clothing/suit/storage/solgov/dress/fleet/flag
	name = "fleet flag officer's dress jacket"
	desc = "A navy blue Sol-Ceti Axis Fleet dress jacket with red accents. Don't get near pasta sauce or vox."
...
/obj/item/clothing/suit/dress/solgov/fleet/sailor
	...
	desc = "A navy blue Sol-Ceti Axis Fleet dress suit. Almost looks like a school-girl outfit."
	icon_state = "sailordress"

/obj/item/clothing/suit/dress/solgov/army
	name = "army dress jacket"
	desc = "A tailored black Sol-Ceti Axis Army dress jacket with red trim. So sexy it hurts."
	icon_state = "blackdress"

/obj/item/clothing/suit/dress/solgov/army/command
	name = "army officer's dress jacket"
	desc = "A tailored black Sol-Ceti Axis Army dress jacket with gold trim. Smells like ceremony."
...
/obj/item/clothing/head/helmet/space/void/command
	...
	desc = "A light, radiation resistant voidsuit helmet commonly used among Sol-Ceti Axis uniformed services."
...
/obj/item/clothing/suit/space/void/command
	...
	desc = "A light, radiation resistant voidsuit commonly used among Sol-Ceti Axis uniformed services. This one has an EC seal on its chest plate and command department markings."
