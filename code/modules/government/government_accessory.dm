...
/obj/item/clothing/accessory/medal/solgov/iron/star
	...
	desc = "An iron star awarded to members of the Axis for meritorious achievement or service in a combat zone."
	icon_state = "iron_star"

/obj/item/clothing/accessory/medal/solgov/iron/sol
	name = "\improper Sol expeditionary medal"
	desc = "An iron medal awarded to members of the Expeditionary Corps for service outside of the borders of the Sol-Ceti Axis."
	icon_state = "iron_sol"

/obj/item/clothing/accessory/medal/solgov/bronze/heart
	name = "bronze heart medal"
	desc = "A bronze heart awarded to members of the Axis for injury or death in the line of duty."
	icon_state = "bronze_heart"

/obj/item/clothing/accessory/medal/solgov/bronze/sol
	name = "\improper Sol defensive operations medal"
	desc = "A bronze medal awarded for members of the Axis for service defending the border regions."
	icon_state = "bronze_sol"

/obj/item/clothing/accessory/medal/solgov/silver/sword
	name = "combat action medal"
	desc = "A silver medal awarded to members of the Axis for honorable service while under enemy fire."
	icon_state = "silver_sword"

/obj/item/clothing/accessory/medal/solgov/silver/sol
	name = "\improper Sol valor medal"
	desc = "A silver medal awarded for members of the Axis for acts of exceptional valor."
	icon_state = "silver_sol"

/obj/item/clothing/accessory/medal/solgov/gold/star
	name = "gold star medal"
	desc = "A gold star awarded to members of the Axis for acts of heroism in a combat zone."
	icon_state = "gold_star"

/obj/item/clothing/accessory/medal/solgov/gold/sun
	name = "solar service medal"
	desc = "A gold medal awarded to members of the Axis by the Secretary General for significant contributions to the Sol-Ceti Axis."
	icon_state = "gold_sun"
...
/obj/item/clothing/accessory/medal/solgov/gold/sol
	...
	desc = "A gold medal awarded for members of the Axis for significant contributions to sapient rights."
	icon_state = "gold_sol"

/obj/item/clothing/accessory/medal/solgov/heart
	name = "medical medal"
	desc = "A white heart emblazoned with a red cross awarded to members of the Axis for service as a medical professional in a combat zone."
...
/obj/item/clothing/accessory/solgov/ec_patch
	...
	desc = "A laminated shoulder patch, carrying the symbol of the Sol-Ceti Axis Expeditionary Corps Observatory, or ECO for short, the eyes and ears of the Expeditionary Corps' missions."
	icon_state = "ecpatch1"
...
/obj/item/clothing/accessory/solgov/ec_patch/fieldops
	...
	desc = "A radiation-shielded shoulder patch, carrying the symbol of the Sol-Ceti Axis Expeditionary Corps Field Operations, or ECFO for short, the hands-on workers of every Expeditionary Corps mission."
	icon_state = "ecpatch2"
...
/obj/item/clothing/accessory/solgov/ec_scarf
	...
	desc = "An Axis blue silk scarf, meant to be worn with Expeditionary Corps uniforms."
...
/obj/item/clothing/accessory/ribbon/solgov/marksman
	...
	desc = "A military decoration awarded to members of the Axis for good marksmanship scores in training. Common in the days of energy weapons."
	icon_state = "ribbon_marksman"

/obj/item/clothing/accessory/ribbon/solgov/peace
	name = "peacekeeping ribbon"
	desc = "A military decoration awarded to members of the Axis for service during a peacekeeping operation."
	icon_state = "ribbon_peace"

/obj/item/clothing/accessory/ribbon/solgov/frontier
	name = "frontier ribbon"
	desc = "A military decoration awarded to members of the Axis for service along the frontier."
	icon_state = "ribbon_frontier"

/obj/item/clothing/accessory/ribbon/solgov/instructor
	name = "instructor ribbon"
	desc = "A military decoration awarded to members of the Axis for service as an instructor."
...
/obj/item/clothing/accessory/solgov/specialty/pilot
	...
	desc = "An iron pin denoting the qualification to fly Axis spacecraft."
...
/obj/item/clothing/accessory/armor/tag/solgov/ec
	...
	desc = "An emblem depicting the crest of the Axis Expeditionary Corps."
	icon_state = "ecflag"
...
/obj/item/clothing/accessory/armor/tag/solgov/agent
	name = "\improper OSI AGENT tag"
	desc = "An armor tag with the words OSI AGENT printed in gold lettering on it."
	icon_state = "agenttag"

/obj/item/clothing/accessory/armor/tag/solgov/com
	name = "\improper Axis tag"
...
/obj/item/clothing/accessory/armor/helmcover/blue/sol
	...
	desc = "A fabric cover for armored helmets. This one is in Axis peacekeeper colors."
